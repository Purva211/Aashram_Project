...
const Layout = ({ children, user }) => {
  ...
  if (user?.role === 'Trustee') {
    ...
    navItems = [
      ...
      { name: 'Vanshawal Dashboard', path: '/branch/vanshawal/dashboard', icon: <FaHistory /> },
      { name: 'Vanshawal Reports', path: '/branch/vanshawal/reports', icon: <FaFileAlt /> },
    ...
    navItems = [
      ...
      { name: 'Vanshawal Dashboard', path: '/admin/vanshawal/dashboard', icon: <FaHistory /> },
      { name: 'Vanshawal Reports', path: '/admin/vanshawal/reports', icon: <FaFileAlt /> },

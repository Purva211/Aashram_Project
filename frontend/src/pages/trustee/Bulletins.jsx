...
const Bulletins = () => {
  ...
  if (loading) return <div className="p-8 font-bold text-gray-600">Loading updates...</div>;

  return (
    <div className="p-4 sm:p-6 md:p-10 w-full max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-caramel-deep font-serif flex flex-wrap items-center gap-2 tracking-tight">
        ...
        {hasManage && (
          <div className="w-full md:w-auto">
            <button 
              ...
              className="flex justify-center items-center gap-2 bg-slate-900 hover:bg-black text-white px-6 py-2.5 rounded-xl shadow-md transition-colors font-black w-full md:w-auto text-sm"
            >
      ...
      {showAddForm && (
        <form onSubmit={handleSubmit} className="bg-white p-4 sm:p-8 rounded-2xl shadow-sm border border-stone-200 mb-10">

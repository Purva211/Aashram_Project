                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <button onClick={() => handleApproveDeletion(doc)} className="p-2 text-red-600 hover:bg-red-50 rounded-lg tooltip flex items-center gap-1" title="Approve Deletion Request">
